...
// Purity Focus Research. Some translation strings were moved to BlightTweaks because the formatting symbol caused problems for some users.
...
mods.thaumcraft.Research.addPage("PURITYFOCUS", "tc.research_page.PURITYFOCUS.BT.1");
mods.thaumcraft.Research.addPage("PURITYFOCUS", "tc.research_page.PURITYFOCUS.BT.2");
...
mods.thaumcraft.Research.addPage("PURITYFOCUS", "tc.research_page.PURITYFOCUS.BT.vacuum");
mods.thaumcraft.Research.addPage("PURITYFOCUS", "tc.research_page.PURITYFOCUS.BT.curative");
mods.thaumcraft.Research.addPage("PURITYFOCUS", "tc.research_page.PURITYFOCUS.BT.blightBuster");
