...
mods.thaumcraft.Aspects.set(<Thaumcraft:WandCasting>, "metallum 4, praecantatio 1, instrumentum 1");
mods.thaumcraft.Aspects.set(<MineFactoryReloaded:glass.helm>, "ordo 4, fabrico 2, ignis 2, tutamen 1");
mods.thaumcraft.Aspects.set(<betterstorage:cardboardSword>, "fabrico 1, telum 1");