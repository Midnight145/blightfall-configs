...
recipes.addShapeless(<minecraft:written_book>.withTag({pages: ["01-VIT-4:
   A bright young Thaumaturge presented a theory to me today. He has shown that the accidental, undirected thaumaturgical potential called Flux has sttrange interactions with certain types of plants. I quickly", "assured him I wanted nothing to do with Forbidden magic, but he told me that this is something else entirely.
...
-by botanists loyal to", "the Dark One. Before we tip our hand, we must ensure that these Botanists can't produce this 'Pure Daisy' for themselves. We'll have to entirely control the means of production, to keep these 'Mystical Flowers' away from the Dark One...especially the", "white ones. I'll need to keep these especially safe. When we collect the sample to be saved, I must guard them personally until the time comes to re-introduce them to the wild after the war ends.
   Xillith assures me that this thaumaturgically", "engineered contagion will only affect those who have corrupted themselves by using blood magic, and while I have no reason to double him, I'm still worried. The purple growths and pink tumors seen o-
...
I have been able to watch its progress a littl,e and came to an interesting fact. This weapon may have a counter. Some of the most magical trees seem to repel the mutagen quite effectively. My", "associates and I have been working diligently trying to study the effects of this mutagen when it comes in contact with this Silverwood Tree, and our efforts have been rewarded.
...
Even now I can hear its mutterings. It's quiet whisperings", "drowning out all sounds...
